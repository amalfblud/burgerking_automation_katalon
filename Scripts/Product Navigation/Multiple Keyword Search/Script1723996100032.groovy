...
WebUI.verifyElementPresent(findTestObject('Page_Index - Burger King/span_Order'), 0)
...
WebUI.setText(findTestObject('Object Repository/Page_King Saver Semua Menu  23K - Burger King/input_-_search'), 'cheese whopper')
