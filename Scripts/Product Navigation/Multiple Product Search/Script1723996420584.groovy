...
WebUI.setText(findTestObject('Object Repository/Page_King Saver Semua Menu  23K - Burger King/input_-_search'), 'whopper')
...
WebUI.click(findTestObject('Page_King Saver Semua Menu  23K - Burger King/input_-_search'))

WebUI.setText(findTestObject('Object Repository/Page_Cheese Whopper Jr - Burger King/input_-_search'), 'chicken')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Cheese Whopper Jr - Burger King/span_Chicken Burger'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Cheese Whopper Jr - Burger King/span_Chicken Burger'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Chicken Burger - Burger King/h1_Chicken Burger'), 'Chicken Burger')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Chicken Burger - Burger King/div_Chicken Burger'), 'Chicken Burger')
