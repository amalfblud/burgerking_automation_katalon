...
WebUI.setText(findTestObject('Object Repository/Page_King Saver Semua Menu  23K - Burger King/input_-_search'), 'whp')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_King Saver Semua Menu  23K - Burger King/li_whpNot Found'), 
    0)
